...
class TestResponseAPILoggingUtils:
    ...
    def test_transform_response_api_usage_preserves_cache_write_tokens(
        self,
        details_as_dict: bool,
    ):
        details = {"cached_tokens": 7, "cache_write_tokens": 11}
        usage = {
            "input_tokens": 100,
            "output_tokens": 20,
            "total_tokens": 120,
        ...
        if not details_as_dict:
            usage = ResponseAPIUsage.model_construct(
                input_tokens=100,
                output_tokens=20,
                total_tokens=120,
                input_tokens_details=SimpleNamespace(**details),
        ...
        assert result.prompt_tokens_details.cache_creation_tokens == 11
